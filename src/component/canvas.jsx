...
function generateShape(element, props) {
...
function Canvas(props) {
  ...
  return (
    <>
      {console.log(props)}
      {/* <canvas id="can" onClick={e => this.draw(this.props.shape, e)}>
       */}
      <canvas
        id="canvas"
        ...
        onMouseMove={e => {
          ...
          generateShape(draggingElement, props);
          drawScene(props);
        }}
      />
    </>
